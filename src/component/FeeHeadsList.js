        ...
        <div className="p-2 bg-white shadow-md rounded-md">
          <div className="bg-blue-50 border border-blue-300 rounded-lg shadow-md p-2 mb-4">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-bold text-blue-800">Fee Heads</h2>
          ...
          <table className="w-full table-auto border border-blue-500">
            <thead className="bg-blue-100 text-sm">
              <tr>
                ...
                <th className="border border-blue-500 px-2 py-1">FeeHead ID</th>
                <th className="border border-blue-500 px-2 py-1">FeeHead Name</th>
                {/* <th className="border border-blue-500 px-2 py-1">Description</th> */}
              ...
              {feeHeads.length > 0 ? (
                paginatedfeeHeads.map((fh,index) => (
                  <tr key={fh._id} className="hover:bg-gray-100 transition">
                    ...
                    <td className="border border-blue-500 px-2 py-1">{fh.feeHeadId}</td>
                    <td className="border border-blue-500 px-2 py-1">{fh.feeHeadName}</td>
                    {/* <td className="border border-blue-500 px-2 py-1">{fh.description}</td> */}
                    <td className="border border-blue-500 px-2 py-1 text-center">
                      <div className="flex justify-center items-center gap-4">
                        <button
                          onClick={() =>
                            navigate("/FeeHeadsMaster", { state: { feeHeadItem: fh,token } })
                          }
