        ...
        <div className="p-2 bg-white shadow-md rounded-md">
          <div className="bg-blue-50 border border-blue-300 rounded-lg shadow-md p-2 mb-4">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-bold text-blue-800">Classes</h2>
          ...
          <table className="w-full table-auto border border-blue-500">
            <thead className="bg-blue-100 text-sm">
              <tr>
                ...
                <th className="border border-blue-500 px-2 py-1">Class ID</th>
                <th className="border border-blue-500 px-2 py-1">Class Name</th>
              ...
              {classes.length > 0 ? (
                paginatedclasses.map((cls,index) => (
                  <tr key={cls._id} className="hover:bg-gray-100 transition">
                    ...
                    <td className="border border-blue-500 px-2 py-1">{cls.classId}</td>
                    <td className="border border-blue-500 px-2 py-1">{cls.className}</td>
                    <td className="border border-blue-500 px-2 py-1">{cls.section}</td>
